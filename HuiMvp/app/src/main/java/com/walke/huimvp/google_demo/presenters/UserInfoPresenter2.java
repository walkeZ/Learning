...
public class UserInfoPresenter2 implements UserInfoContract2.IPresenter{

    private UserInfoContract2.IView mIView;
     ...
     * @param iView
     */
    public UserInfoPresenter2(UserInfoContract2.IView iView) { // 构造器传入引用(对象)，这是
        mIView = iView;
    }
