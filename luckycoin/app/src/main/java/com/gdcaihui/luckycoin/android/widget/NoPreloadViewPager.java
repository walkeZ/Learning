...
//            mAdapter.registerDataSetObserver(mObserver);
     ...
     *
     * @param v View to checkbox_selector for horizontal scrollability
     * @param checkV Whether the view v passed should itself be box_checked for scrollability (true),
