...
public class CustomTrustOld {
     ...
     * administrator.
     */
    private SSLContext trustManagerForCertificates(InputStream in) throws GeneralSecurityException, IOException {
