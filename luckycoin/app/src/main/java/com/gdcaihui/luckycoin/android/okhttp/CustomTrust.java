...
//    public final OkHttpClient client;
     ...
     */
    public static InputStream trustedCertificatesInputStream(Context context) {
        // PEM files for root certificates of Comodo and Entrust. These two CAs are sufficient to view
        // https://publicobject.com (Comodo) and https://squareup.com (Entrust). But they aren't
        // sufficient to connect to most HTTPS sites including https://godaddy.com and https://visa.com.
        // Typically developers will need to get a PEM file from their organization's TLS administrator.

        return context.getResources().openRawResource(R.raw.yangjiang) ;
     ...
     * administrator.
     */
    public static SSLContext trustManagerForCertificates(InputStream in) throws GeneralSecurityException, IOException {
