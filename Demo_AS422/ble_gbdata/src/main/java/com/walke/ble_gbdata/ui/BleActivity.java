package com.walke.ble_gbdata.ui;
...
import com.walke.ble_gbdata.ui.adapter.ScanAdapter;
...
//                if (TextUtils.isEmpty(bleName) || !bleName.startsWith("het")) {
//                    return;
//                }
                String s = new String(scanRecord);
                Log.i("ArHui", "onLeScan: -----> s = " + s);
                ScanRecord record = ScanRecord.parseFromBytes(scanRecord);
                device.setScanRecord(record);
                device.setRssi(rssi);
