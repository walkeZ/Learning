package com.walke.ble_gbdata.ui.adapter;
...
import com.walke.ble_gbdata.R;
import com.walke.ble_gbdata.Utils;
import com.walke.ble_gbdata.base.RecyclerAdapter;
import com.walke.ble_gbdata.base.RecyclerViewHolder;
import com.walke.ble_gbdata.bean.BleRssiDevice;
...
//                        .putExtra(DeviceInfoActivity.EXTRA_TAG, device));
        ...
        if (scanRecord != null){
            ...
            if (array.size() > 0){
                ...
                // -----> --- het-D0084F-172-1,AD:Company: Reserved ID<0xbbaa>0000c4f100ac0126000000405ee1d0084f
                Log.e("ArHui", "convert: -----> --- "+ device.getBleName() +  ",AD:"+ text);
                tv_manufacturer_data.setText(text);
            }
