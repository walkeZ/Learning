...
public class SerialInputOutputManager implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                if (getState() != State.RUNNING) {
                    LogUtil.i("Stopping mState=" + getState());
                    break;
                }
                step();
            }
            ...
            if (mSerialPort.isOpen()) {
                LogUtil.w("Run ending due to exception: " + e.getMessage());
            } else {
                LogUtil.i("Socket closed");
            }
    ...
    private void step() throws IOException {
        ...
        if (buffer != null) {
            if (DEBUG) {
                LogUtil.d("Writing data len=" + len);
            }
