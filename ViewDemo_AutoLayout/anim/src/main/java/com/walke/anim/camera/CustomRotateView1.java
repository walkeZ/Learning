...
public class CustomRotateView1 extends View {
    ...
    public CustomRotateView1(Context context) {
        this(context,null);
    }

    public CustomRotateView1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public CustomRotateView1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        Log.i("walke", "CustomRotateView1  onDraw: ----> degrees = "+degrees+"--- centerX = "+centerX+"--- centerY = "+centerY);
//
...
//        canvas.setMatrix(mMatrix);
        Log.i("walke", "CustomRotateView1 draw: -------> centerX = "+centerX+" ---> centerY = "+centerY );
