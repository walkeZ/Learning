...
public class CustomRotateView2 extends View {
    ...
    public CustomRotateView2(Context context) {
        this(context,null);
    }

    public CustomRotateView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public CustomRotateView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        mY1+=2;
        ...
        mCamera.restore();
        Log.i("walke", "CustomRotateView2 draw: -------> centerX = "+centerX+" ---> centerY = "+centerY );
