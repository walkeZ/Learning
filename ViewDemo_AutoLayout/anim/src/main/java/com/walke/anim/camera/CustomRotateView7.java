...
public class CustomRotateView7 extends View {
    ...
    public CustomRotateView7(Context context) {
        this(context,null);
    }

    public CustomRotateView7(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public CustomRotateView7(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
