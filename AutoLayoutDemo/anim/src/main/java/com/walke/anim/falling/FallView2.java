...
public class FallView2 extends View {
    ...
    public FallView2(Context context) {
        this(context,null);
    }

    public FallView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }
    public FallView2(Context context,Bitmap bm,  int alpha, float speed) {
        super(context);
        mSnow = bm;
        mPaint = new Paint();
        mCamera = new Camera();
    ...
    public FallView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
