...
public class CustomRotateView5 extends View {
    ...
    public CustomRotateView5(Context context) {
        this(context,null);
    }

    public CustomRotateView5(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public CustomRotateView5(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        mY1+=2;
       ...
       /* if (mY1>-(mHeight-mSnow.getHeight())){
        ...
        mCamera.restore();
        Log.i("walke", "CustomRotateView5 draw: -------> mX1 = "+mX1+" ---> mY1 = "+mY1 );
        Log.i("walke", "CustomRotateView5 draw: -------> centerX = "+centerX+" ---> centerY = "+centerY );
