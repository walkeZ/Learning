...
public class CustomRotateView9 extends View {
    ...
    public CustomRotateView9(Context context) {
        this(context,null);
    }

    public CustomRotateView9(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public CustomRotateView9(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        mSnow = BitmapFactory.decodeResource(getContext().getResources(), R.mipmap.image_snow);
    ...
    protected void onDraw(Canvas canvas) {
       ...
       /* if (mY1>-(mHeight-mSnow.getHeight())){
        ...
        sz++;
        mCamera.translate(mX1, mY1, sz);// mY1: -50
        ...
        mCamera.restore();
        Log.i("walke", "CustomRotateView6 draw: -------> mX1 = "+mX1+" ---> mY1 = "+mY1 );
        Log.i("walke", "CustomRotateView6 draw: -------> centerX = "+centerX+" ---> centerY = "+centerY );
