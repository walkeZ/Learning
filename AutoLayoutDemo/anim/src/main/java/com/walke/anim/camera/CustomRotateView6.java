...
public class CustomRotateView6 extends View {
    ...
    public CustomRotateView6(Context context) {
        this(context,null);
    }

    public CustomRotateView6(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public CustomRotateView6(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
