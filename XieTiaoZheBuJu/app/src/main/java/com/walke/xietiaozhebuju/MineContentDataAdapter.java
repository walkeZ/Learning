 ...
 */
public class MineContentDataAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private List<MineContentData.DataBean.LinklistBean> list;
    private LayoutInflater inflater;
    private String mTime;

    public MineContentDataAdapter(Context context, List<MineContentData.DataBean.LinklistBean> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        MineContentData.DataBean.LinklistBean bean = list.get(position);
    ...
    public void addAll(List<MineContentData.DataBean.LinklistBean> linklist, boolean isclear) {
        if (list != null) {
            if (isclear) {
